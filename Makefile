...
SRCS =	ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	...
	ft_putstr_fd.c ft_putstr.c ft_revmemcpy.c ft_strcat.c ft_strchr.c \
	ft_strclr.c ft_strcmp.c ft_strcpy.c ft_strdel.c ft_strdup.c ft_strequ.c \
	ft_striter.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlen_c.c \
	...
	ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_atoi.c
